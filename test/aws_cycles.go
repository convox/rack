...
func CreateAppStackCycle(appName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", createAppUrlBody()},
...
func DescribeAppStackCycle(stackName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", `Action=DescribeStacks&StackName=` + stackName + `&Version=2010-05-15`},
		awsutil.Response{200,
...
func GetAppTemplateCycle(stackName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", `Action=GetTemplate&StackName=` + stackName + `&Version=2010-05-15`},
		awsutil.Response{200, ""},
	}
}
...
func DescribeStackCycleWithoutQuery(appName string) awsutil.Cycle {
	...
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", `Action=DescribeStacks&Version=2010-05-15`},
...
func DeleteStackCycle(stackName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", `Action=DeleteStack&StackName=` + stackName + `&Version=2010-05-15`},
		awsutil.Response{200, ""},
	}
}
