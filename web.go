...
func main() {
	...
	router.HandleFunc("/clusters/{cluster}/apps", controllers.AppCreate).Methods("POST")
	router.HandleFunc("/clusters/{cluster}/apps/{app}", controllers.AppShow).Methods("GET")
	router.HandleFunc("/clusters/{cluster}/apps/{app}", controllers.AppDelete).Methods("DELETE")
	router.HandleFunc("/clusters/{cluster}/apps/{app}/builds", controllers.AppBuilds).Methods("GET")
	router.HandleFunc("/clusters/{cluster}/apps/{app}/build", controllers.BuildCreate).Methods("POST")
	router.HandleFunc("/clusters/{cluster}/apps/{app}/environment", controllers.AppEnvironment).Methods("GET")
	router.HandleFunc("/clusters/{cluster}/apps/{app}/environment", controllers.EnvironmentSet).Methods("POST")
