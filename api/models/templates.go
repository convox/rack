...
func templates_app_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/app.tmpl", size: 13268, mode: os.FileMode(420), modTime: time.Unix(1452784396, 0)}
...
func templates_service_papertrail_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/service/papertrail.tmpl", size: 3146, mode: os.FileMode(420), modTime: time.Unix(1448304259, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
