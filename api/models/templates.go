...
func templates_service_postgres_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/service/postgres.tmpl", size: 2634, mode: os.FileMode(420), modTime: time.Unix(1444774172, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templates_service_redis_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/service/redis.tmpl", size: 2125, mode: os.FileMode(420), modTime: time.Unix(1444351384, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
