...
func templates_app_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/app.tmpl", size: 10237, mode: os.FileMode(420), modTime: time.Unix(1442958339, 0)}
...
func templates_service_mysql_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/service/mysql.tmpl", size: 2609, mode: os.FileMode(420), modTime: time.Unix(1442958339, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
