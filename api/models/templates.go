...
func templatesAppTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/app.tmpl", size: 14220, mode: os.FileMode(420), modTime: time.Unix(1453404661, 0)}
