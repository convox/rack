...
func templatesServiceWebhookTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/webhook.tmpl", size: 782, mode: os.FileMode(420), modTime: time.Unix(1445552664, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
