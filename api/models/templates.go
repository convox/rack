...
func templatesServiceMysqlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/mysql.tmpl", size: 3346, mode: os.FileMode(420), modTime: time.Unix(1458174530, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesServicePostgresTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/postgres.tmpl", size: 4072, mode: os.FileMode(420), modTime: time.Unix(1458174534, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesServiceRedisTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/redis.tmpl", size: 3061, mode: os.FileMode(420), modTime: time.Unix(1458174526, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
