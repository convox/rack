...
func templates_app_tmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/app.tmpl", size: 12291, mode: os.FileMode(420), modTime: time.Unix(1445882989, 0)}
