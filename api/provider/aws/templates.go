...
func templatesServiceFluentdTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/fluentd.tmpl", size: 4784, mode: os.FileMode(420), modTime: time.Unix(1469652328, 0)}
...
func templatesServiceSyslogTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/service/syslog.tmpl", size: 4758, mode: os.FileMode(420), modTime: time.Unix(1465162563, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
