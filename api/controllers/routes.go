...
func NewRouter() (router *mux.Router) {
	...
	router.HandleFunc("/apps/{app}/builds/import", api("build.import", BuildImport)).Methods("POST")
	...
	router.HandleFunc("/apps/{app}/processes/{process}/files", api("files.delete", FilesDelete)).Methods("DELETE")
	router.HandleFunc("/apps/{app}/processes/{process}/files", api("files.upload", FilesUpload)).Methods("POST")
	router.HandleFunc("/apps/{app}/objects/{key:.*}", api("object.fetch", ObjectFetch)).Methods("GET")
	router.HandleFunc("/apps/{app}/objects/{key:.*}", api("object.store", ObjectStore)).Methods("POST")
	...
	router.HandleFunc("/apps/{app}/releases", api("release.create", ReleaseCreate)).Methods("POST")
	...
	router.HandleFunc("/apps/{app}/services", api("service.list", ServiceList)).Methods("GET")
	...
	router.HandleFunc("/events/{action}", api("event.send", EventSend)).Methods("POST")
	...
	router.HandleFunc("/resources/{resource}/links", api("resource.link.create", LinkCreate)).Methods("POST")
	router.HandleFunc("/resources/{resource}/links/{app}", api("resource.link.delete", LinkDelete)).Methods("DELETE")
	...
	router.HandleFunc("/services", api("service.list", ResourceList)).Methods("GET")
	router.HandleFunc("/services", api("service.create", ResourceCreate)).Methods("POST")
	router.HandleFunc("/services/{resource}", api("service.show", ResourceShow)).Methods("GET")
	router.HandleFunc("/services/{resource}", api("service.update", ResourceUpdate)).Methods("PUT")
	router.HandleFunc("/services/{resource}", api("service.delete", ResourceDelete)).Methods("DELETE")
	router.HandleFunc("/services/{resource}/links", api("service.link.create", LinkCreate)).Methods("POST")
	router.HandleFunc("/services/{resource}/links/{app}", api("service.link.delete", LinkDelete)).Methods("DELETE")
