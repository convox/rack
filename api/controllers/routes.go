...
func NewRouter() (router *mux.Router) {
	...
	// backwards compatibility for calls to /services, which has been changed to /resources
	...
	router.HandleFunc("/services/{service}", api("resource.show", ResourceShow)).Methods("GET")
	router.HandleFunc("/services/{service}", api("resource.update", ResourceUpdate)).Methods("PUT")
