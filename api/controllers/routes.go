...
func NewRouter() (router *mux.Router) {
	...
	router.HandleFunc("/apps/{app}/processes/{pid}", api("process.get", ProcessShow)).Methods("GET")
	router.HandleFunc("/apps/{app}/processes/{pid}", api("process.stop", ProcessStop)).Methods("DELETE")
