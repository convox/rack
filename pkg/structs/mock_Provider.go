...
func (_m *MockProvider) DeleteDB(resource string) error {
...
func (_m *MockProvider) IsDBSnapshotComplete(snapshot string) (bool, error) {
...
func (_m *MockProvider) SetDBDeletionProtectionAndCreateSnapShot(app string, resource string, snapshot string) (string, error) {
...
func (_m *MockProvider) WithContext(ctx context.Context) Provider {
	...
	var r0 Provider
	if rf, ok := ret.Get(0).(func(context.Context) Provider); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
