...
func TestManifestLoad(t *testing.T) {
	n := &manifest.Manifest{
		...
		Services: manifest.Services{
			manifest.Service{
				...
				Hooks: manifest.ServiceHooks{
					BeforePromote: "bin/before",
				},
				Init:      true,
			...
			manifest.Service{
				...
				Hooks: manifest.ServiceHooks{
					BeforePromote: "bin/before1",
					AfterPromote:  "bin/after2",
				},
				Scale: manifest.ServiceScale{
					Count:  manifest.ServiceScaleCount{Min: 1, Max: 1},
					Cpu:    256,
	...
	attrs := []string{"services.proxy.environment",
		...
		"services.api.hooks",
		"services.api.hooks.before-promote",
		"services.api.init",
		"services.api.port",
		...
		"services.baz",
		"services.baz.hooks",
		"services.baz.hooks.after-promote",
		"services.baz.hooks.before-promote",
		"services.foo",
