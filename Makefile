...
release: build
	docker tag -f convox/agent:latest convox/agent:0.61
	docker push convox/agent:0.61
	AWS_DEFAULT_PROFILE=release aws s3 cp convox.conf s3://convox/agent/0.61/convox.conf --acl public-read
