...
release: build
	docker tag -f convox/agent:latest convox/agent:0.62
	docker push convox/agent:0.62
	AWS_DEFAULT_PROFILE=release aws s3 cp convox.conf s3://convox/agent/0.62/convox.conf --acl public-read
