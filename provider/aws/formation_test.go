...
//   models.TestProvider.On("FormationGet", "application", "main").Return(models.TestProvider.ProcessFormation, nil)
//   models.TestProvider.On("FormationSave", "application", &models.TestProvider.ProcessFormation).Return(nil)
...
//   // setup expectations on current provider
//   models.TestProvider.On("FormationGet", "application", "main").Return(models.TestProvider.ProcessFormation, nil)
//   models.TestProvider.On("FormationSave", "application", &models.TestProvider.ProcessFormation).Return(fmt.Errorf("requested memory 2048 grenil)
