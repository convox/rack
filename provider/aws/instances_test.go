...
func listContainerInstancesCycle(clusterName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "AmazonEC2ContainerServiceV20141113.ListContainerInstances",
...
func describeContainerInstancesCycle(clusterName string) awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "AmazonEC2ContainerServiceV20141113.DescribeContainerInstances",
			`{"cluster":"` + clusterName + `",
        "containerInstances": [
...
func describeInstancesCycle() awsutil.Cycle {
	return awsutil.Cycle{
		awsutil.Request{"GET", "/", "", `Action=DescribeInstances&Filter.1.Name=instance-id&Filter.1.Value.1=i-4a5513f4&Filter.1.Value.2=i-3963798e&Filter.1.Value.3=i-c6a72b76&MaxResults=1000&Version=2016-04-01`},
