...
var cycleServiceDescribeStacks1 = awsutil.Cycle{
	awsutil.Request{"GET", "/", "", `Action=DescribeStacks&StackName=syslog&Version=2010-05-15`},
	awsutil.Response{
		200,
