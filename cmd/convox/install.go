...
func cmdInstall(c *cli.Context) {
	...
	if err != nil {
		stdcli.EventSendError("cli-install", distinctId, err)
	}
	...
	if creds == nil {
		stdcli.EventSendError("cli-install", distinctId, fmt.Errorf("error reading credentials"))
	}
...
func cmdUninstall(c *cli.Context) {
	...
	distinctId, err := currentId()
	if err != nil {
		stdcli.EventSendError("cli-uninstall", distinctId, err)
	}
	...
	if creds == nil {
		stdcli.EventSendError("cli-uninstall", distinctId, fmt.Errorf("error reading credentials"))
	}
