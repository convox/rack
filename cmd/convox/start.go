...
func cmdStart(c *cli.Context) {
	...
	err = dockerTest.Run()
	if err != nil {
		derr := errors.New("could not connect to docker daemon, is it installed and running?")
		stdcli.QOSEventSend("cli-start", distinctId, stdcli.QOSEventProperties{Error: derr})
	}
