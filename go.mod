...
require (
	...
	github.com/docker/docker v1.4.2-0.20200323100002-91437e70a02d
...
// Pin x/sys to a mid-2019 commit that still supports Docker’s old pointer usage
replace golang.org/x/sys => golang.org/x/sys v0.0.0-20190302025703-b6889370fb10
